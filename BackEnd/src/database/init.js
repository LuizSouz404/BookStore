...
const initDB = {
  async init() {
    ...
    CREATE TABLE "books" ("id" varchar PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "author" varchar NOT NULL, "synopsis" varchar NOT NULL, "url" varchar NOT NULL, "categoryID" integer NOT NULL);
    ...
    CREATE TABLE "temporary_books" ("id" varchar PRIMARY KEY NOT NULL, "title" varchar NOT NULL, "author" varchar NOT NULL, "synopsis" varchar NOT NULL, "url" varchar NOT NULL, "categoryID" integer NOT NULL, CONSTRAINT "foreignKeyCategory" FOREIGN KEY ("categoryID") REFERENCES "categories" ("key") ON DELETE SET NULL ON UPDATE CASCADE);
    INSERT INTO "temporary_books"("id", "title", "author", "synopsis", "url", "categoryID") SELECT "id", "title", "author", "synopsis", "url", "categoryID" FROM "books";
    DROP TABLE "books";
